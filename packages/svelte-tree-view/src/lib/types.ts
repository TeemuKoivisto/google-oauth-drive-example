...
export type NodeComponent = new (...args: any) => SvelteComponentTyped<{
  node: TreeNode
...
export interface TreeViewProps {
  ...
  nodeComponent?: NodeComponent // The fully customizable component to replace all content within the li element
